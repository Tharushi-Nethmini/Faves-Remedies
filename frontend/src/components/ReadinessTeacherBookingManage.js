...
export default function ReadinessTeacherBookingManage() {
  ...
  const getBooking = () => {
    axios
      .get("http://localhost:8070/readiness-teacher/view-booking")
      .then((res) => {
  ...
  const saveEdit = (bookingid) => {
    axios
      .put(`http://localhost:8070/readiness-teacher/update-booking/${bookingid}`, formData)
      .then(() => {
  ...
  const deleteData = (bookingid) => {
    axios
      .delete(`http://localhost:8070/readiness-teacher/delete-booking/${bookingid}`)
      .then(() => {
