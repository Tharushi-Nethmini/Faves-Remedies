...
export default function ShadowTeacherBookingManage() {
  ...
  const getBooking = () => {
    axios
      .get("http://localhost:8070/shadow-teacher/view-booking")
      .then((res) => {
  ...
  const saveEdit = (bookingid) => {
    axios
      .put(`http://localhost:8070/shadow-teacher/update-booking/${bookingid}`, formData)
      .then(() => {
  ...
  const deleteData = (bookingid) => {
    axios
      .delete(`http://localhost:8070/shadow-teacher/delete-booking/${bookingid}`)
      .then(() => {
  ...
  return (
    <><><DashboardNavbar /><div className="main-container">
      <div className="content-container">
        <h1 className="page-title">Shadow Teacher Bookings</h1>
                ...
                <tr key={item._id}>
                  ...
                  <td>
                    {editedItem === item._id ? (
                      <input
                        type="text"
                        name="schoolTimeDuration"
                        value={formData.schoolTimeDuration || ""}
                        onChange={handleInputChange} />
                    ) : (
                      item.schoolTimeDuration
                    )}
                  </td>
                  <td>
                    {editedItem === item._id ? (
