...
export default function SpecialNeedTeacherBookingManage() {
  ...
  const getBooking = () => {
    axios
      .get("http://localhost:8070/special-need-teacher/view-booking")
      .then((res) => {
  ...
  const saveEdit = (bookingid) => {
    axios
      .put(`http://localhost:8070/special-need-teacher/update-booking/${bookingid}`, formData)
      .then(() => {
  ...
  const deleteData = (bookingid) => {
    axios
      .delete(`http://localhost:8070/special-need-teacher/delete-booking/${bookingid}`)
      .then(() => {
  ...
  return (
    <><><DashboardNavbar /><div className="main-container">
      <div className="content-container">
        <h1 className="page-title">Special needs teacher for Home.</h1>
