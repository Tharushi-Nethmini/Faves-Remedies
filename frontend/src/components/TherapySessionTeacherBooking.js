...
import '../stylesheet/TherapySessionTeacherBooking.css'; // External CSS file for styling
import logo from "../assets/logo.png";
import Header from './Header';
import axios from "axios";

export default function TherapySessionTeacherBooking() {
    ...
    function sendData(e) {
      ...
      axios.post("http://localhost:8070/therapy-session-teacher/add-booking", newBooking)
        .then((response) => {
        ...
        <div className="card">
          <div className="content">
            <div className="title-section">
              <h2 style={{ color: '#203822' }}>Book a Teacher for Speech and Behavior occupational Therapy sessions</h2>
