...
import '../stylesheet/SpecialNeedTeacherBooking.css'; // External CSS file for styling
import logo from "../assets/logo.png";
import axios from "axios";
import Header from './Header';
import Footer from './Footer';

export default function SpecialNeedTeacherBooking() {
  ...
  function sendData(e) {
    ...
    axios.post("http://localhost:8070/special-need-teacher/add-booking", newBooking)
      .then((response) => {
      ...
      <div className="card">
        <div className="content">
          <div className="title-section">
            <h2>Book a Special Needs Teacher</h2>
