...
export default function CounsellingTeacherBookingManage() {
  ...
  const getBooking = () => {
    axios
      .get("http://localhost:8070/counselling-teacher/view-booking")
      .then((res) => {
  ...
  const saveEdit = (bookingid) => {
    axios
      .put(`http://localhost:8070/counselling-teacher/update-booking/${bookingid}`, formData)
      .then(() => {
  ...
  const deleteData = (bookingid) => {
    axios
      .delete(`http://localhost:8070/counselling-teacher/delete-booking/${bookingid}`)
      .then(() => {
    ...
    <>
      ...
      <div className="main-container">
        <div className="content-container">
          <h1 className="page-title">Student Counseling Teacher Bookings</h1>
          <select onChange={handleNavigate} className="category-select">
